...
list = [name for name in names if fnmatch(name, 'Dat*.csv')]
print(list)  # ['Dat1.csv', 'Dat2.csv']
...
st_address = [addr for addr in addresses if fnmatchcase(addr, '* ST')]
print(st_address)  # ['5412 N CLARK ST', '1060 W ADDISON ST', '2122 N CLARK ST']
addr = [addr for addr in addresses if fnmatchcase(addr, '54[0-9][0-9] *CLARK*')]
print(addr)  # ['5412 N CLARK ST']
