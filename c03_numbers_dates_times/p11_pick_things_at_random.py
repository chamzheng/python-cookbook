...
print(random.sample(values, 2)) # [4, 6]...

# 如果你仅仅只是想打乱序列中元素的顺序，可以使用 random.shuffle()
random.shuffle(values)
print(values)  # [6, 3, 5, 1, 4, 2]
...
# 1216763399722040929890220167180822982494060790477190206514210
...
random.seed(b'')  # Seed based on byte data
